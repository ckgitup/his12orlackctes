...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.saveGasUrlSettings = function() {
    ...
    window.GAS_API_URL = newUrl;
    localStorage.setItem("sejarah_gas_url", newUrl);
    ...
    if (msgEl) {
      ...
      msgEl.textContent = newUrl ? `✅ URL Cloud Apps Script Disimpan! (${newUrl})` : "ℹ️ Menggunakan Mode Offline Lokal (Tanpa Sync Cloud)";
    }
    showTeacherToast("URL Cloud GAS Berhasil Disimpan!");
  };
